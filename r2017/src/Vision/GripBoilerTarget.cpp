#include "GripBoilerTarget.h"

namespace grip {

GripBoilerTarget::GripBoilerTarget() {
}
/**
 ...
 */
cv::Mat* GripBoilerTarget::GetHsvThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GripBoilerTarget::GetFindContoursOutput(){
...
std::vector<std::vector<cv::Point> >* GripBoilerTarget::GetFilterContoursOutput(){
	 ...
	 */
	void GripBoilerTarget::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void GripBoilerTarget::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GripBoilerTarget::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
