...
void PathPlanner::Paths(vector<vector<double>*>* smoothPath, double robotTrackWidth, double robotTrackLength)
{
    ...
    for(int i=0;i<smoothPath->size();i++)
    {
        ...
        this->leftLowerPath->operator[](i) = new double[3];
        this->rightLowerPath->operator[](i) = new double[3];
        this->leftUpperPath->operator[](i) = new double[3];
        this->rightUpperPath->operator[](i) = new double[3];
        ...
        this->leftLowerPath->operator[](i)[2] = angInDeg;
        ...
        this->rightUpperPath->operator[](i)[2] = angInDeg;
        ...
        this->leftUpperPath->operator[](i)[2] = angInDeg;
        ...
        this->rightLowerPath->operator[](i)[2] = angInDeg;
