#ifndef LeftPegGearSprintCommandGroup_H
#define LeftPegGearSprintCommandGroup_H
...
class LeftPegGearSprintCommandGroup : public CommandGroup {
public:
	LeftPegGearSprintCommandGroup() : CommandGroup("LeftPegGearSprintCommandGroup"){
		...
		AddSequential(new SetAngleOptimizedCommand(true));
		AddSequential(new RotateToAngleMotionMagicCommandGroup(-90));
	}
};

#endif  // LeftPegGearSprintCommandGroup_H
